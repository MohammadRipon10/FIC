...
def baliho():
	try:
		...
		print (W + '     [' + G +'Facebook Information Cracker'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     HackelRipon
    Name       Facebook Information Cracker
    Version    Full Version
    Date       08/04/2019 
    Jabber     tusharripon10@gmail.com
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'HackelRipon' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'HackelRipon' + W +'/' + R +'Bot ' + W + '>> ')
